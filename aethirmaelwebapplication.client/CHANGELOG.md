...
- Create Angular project with ng: `ng new aethirmaelwebapplication.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`aethirmaelwebapplication.client.esproj`).
